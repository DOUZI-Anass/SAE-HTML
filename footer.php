...
<footer>
    <div class="container py-5">
        <div class="row gy-4 text-center text-md-start">
            ...
            <div class="col-md-3"><h5>Suivez-nous</h5><div class="d-flex gap-3 fs-4 justify-content-center justify-content-md-start"><i class="bi bi-facebook"></i><i class="bi bi-twitter-x"></i><i class="bi bi-linkedin"></i></div></div>
