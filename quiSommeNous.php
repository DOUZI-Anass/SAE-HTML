...
require 'header.php';
?>
<link href="assets/quiSommeNous.css" rel="stylesheet">

<section class="container py-5 mt-5"> <h2 class="section-title text-center mb-4">Qui sommes-nous ?</h2>
<p class="lead text-center"> La <strong>FAGE</strong>, Fédération des Associations Générales Étudiantes, est la première organisation étudiante représentative en France.
Fondée en 1989, elle repose sur la démocratie participative. Elle regroupe près de 2 000 associations et syndicats, via des fédérations territoriales et de filière, soit environ 300 000 jeunes. </p>
</section>
